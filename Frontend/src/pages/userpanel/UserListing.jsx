...
import UserProductTile from '@/components/userpanel/UserProductTile'; // ✅ Ensure this import is correct
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-4'>
          {productList && productList.length > 0 ? (
            productList.map((productItem) => (
              <UserProductTile
                key={productItem._id} // ✅ Added key
                product={productItem}
                handleGetProductDetails={() => {}} 
                handleAddtoCart={() => {}} // ✅ Optional placeholder
              />
            ))
          ) : (
